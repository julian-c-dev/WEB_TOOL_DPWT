const styles = {
  ...
  preview2TileSelection: "py-16 px-16 gap-2",
  preview4TileSelection: "py-8 px-16 gap-2",
  preview6TileSelection: "py-8 px-12 gap-2",
  preview8TileSelection: "py-8 px-8 gap-2",
};
